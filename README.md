...
The saltext-servicenow project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-servicenow.git
...
* Writing blog posts
* Sharing your experiences using Salt + ServiceNow
  on social media
...
[docs]: https://salt-extensions.github.io/saltext-servicenow/
